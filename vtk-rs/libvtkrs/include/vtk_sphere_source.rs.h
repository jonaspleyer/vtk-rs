...
extern "C" {
::vtkSphereSource *cxxbridge1$192$vtk_sphere_source_new() noexcept {
  ::vtkSphereSource *(*vtk_sphere_source_new$)() = ::vtk_sphere_source_new;
  return vtk_sphere_source_new$();
}

void cxxbridge1$192$vtk_sphere_source_delete(::vtkSphereSource &ptr) noexcept {
  void (*vtk_sphere_source_delete$)(::vtkSphereSource &) = ::vtk_sphere_source_delete;
  vtk_sphere_source_delete$(ptr);
}

void cxxbridge1$192$vtk_sphere_source_set_radius(::vtkSphereSource &sphere_source, double radius) noexcept {
...
double cxxbridge1$192$vtk_sphere_source_get_radius(::vtkSphereSource const &sphere_source) noexcept {
...
void cxxbridge1$192$vtk_sphere_source_set_center(::vtkSphereSource &sphere_source, ::std::array<double, 3> *center) noexcept {
...
void cxxbridge1$192$vtk_sphere_source_get_center(::vtkSphereSource const &sphere_source, ::std::array<double, 3> *return$) noexcept {
...
void cxxbridge1$192$vtk_sphere_source_set_phi_resolution(::vtkSphereSource &sphere_source, ::std::int64_t resolution) noexcept {
...
::std::int64_t cxxbridge1$192$vtk_sphere_source_get_phi_resolution(::vtkSphereSource const &sphere_source) noexcept {
...
void cxxbridge1$192$vtk_sphere_source_set_theta_resolution(::vtkSphereSource &sphere_source, ::std::int64_t resolution) noexcept {
...
::std::int64_t cxxbridge1$192$vtk_sphere_source_get_theta_resolution(::vtkSphereSource const &sphere_source) noexcept {
