...
void cxxbridge1$192$vtk_object_remove_all_observers(::vtkObject &object) noexcept {
  void (*vtk_object_remove_all_observers$)(::vtkObject &) = ::vtk_object_remove_all_observers;
  vtk_object_remove_all_observers$(object);
}

::std::uint64_t cxxbridge1$192$vtk_object_has_observer(::vtkObject const &object, ::std::uint64_t event) noexcept {
