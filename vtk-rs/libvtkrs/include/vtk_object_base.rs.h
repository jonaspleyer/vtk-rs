...
extern "C" {
void cxxbridge1$192$vtk_object_base_get_class_name(::vtkObjectBase const &obj, ::rust::String *return$) noexcept {
...
void cxxbridge1$192$vtk_object_base_get_object_description(::vtkObjectBase const &obj, ::rust::String *return$) noexcept {
...
bool cxxbridge1$192$vtk_object_base_is_a(::vtkObjectBase const &obj, ::rust::Str class_name) noexcept {
  bool (*vtk_object_base_is_a$)(::vtkObjectBase const &, ::rust::Str) = ::vtk_object_base_is_a;
  return vtk_object_base_is_a$(obj, class_name);
}

::std::int64_t cxxbridge1$192$vtk_object_base_get_number_of_generations_from_base(::vtkObjectBase const &obj, ::rust::Str base_class) noexcept {
...
void cxxbridge1$192$vtk_object_base_fast_delete(::vtkObjectBase &obj) noexcept {
  void (*vtk_object_base_fast_delete$)(::vtkObjectBase &) = ::vtk_object_base_fast_delete;
  vtk_object_base_fast_delete$(obj);
}

::std::int64_t cxxbridge1$192$vtk_object_base_get_reference_count(::vtkObjectBase const &obj) noexcept {
...
void cxxbridge1$192$vtk_object_base_set_reference_count(::vtkObjectBase &obj, ::std::int64_t count) noexcept {
...
bool cxxbridge1$192$vtk_object_base_get_is_in_memkind(::vtkObjectBase const &obj) noexcept {
...
void cxxbridge1$192$vtk_object_base_print_self(::vtkObjectBase const &obj, ::std::uint64_t indent, ::rust::String *return$) noexcept {
...
void cxxbridge1$192$vtk_object_base_print_header(::vtkObjectBase const &obj, ::std::uint64_t indent, ::rust::String *return$) noexcept {
...
void cxxbridge1$192$vtk_object_base_print_trailer(::vtkObjectBase const &obj, ::std::uint64_t indent, ::rust::String *return$) noexcept {
...
bool cxxbridge1$192$vtk_object_base_uses_garbage_collector(::vtkObjectBase const &obj) noexcept {
