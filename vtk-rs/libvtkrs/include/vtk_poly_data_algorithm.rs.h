...
extern "C" {
::vtkPolyDataAlgorithm *cxxbridge1$192$vtk_poly_data_algorithm_new() noexcept {
  ::vtkPolyDataAlgorithm *(*vtk_poly_data_algorithm_new$)() = ::vtk_poly_data_algorithm_new;
  return vtk_poly_data_algorithm_new$();
}

void cxxbridge1$192$vtk_poly_data_algorithm_delete(::vtkPolyDataAlgorithm &poly_data_algorithm) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_get_input(::vtkPolyDataAlgorithm const &vtk_poly_data_algorithm, ::std::int64_t port, ::vtkDataObject const **return$) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_get_poly_data_input(::vtkPolyDataAlgorithm const &vtk_poly_data_algorithm, ::std::int64_t port, ::vtkPolyData const **return$) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_get_output(::vtkPolyDataAlgorithm const &vtk_poly_data_algorithm, ::std::int64_t port, ::vtkPolyData const **return$) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_set_output(::vtkPolyDataAlgorithm &vtk_poly_data_algorithm, ::vtkDataObject const &data_object) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_set_input_data(::vtkPolyDataAlgorithm &poly_data_algorithm, ::std::int64_t port, ::vtkDataObject const &data_object) noexcept {
...
void cxxbridge1$192$vtk_poly_data_algorithm_add_input_data(::vtkPolyDataAlgorithm &poly_data_algorithm, ::std::int64_t port, ::vtkDataObject const &data_object) noexcept {
