...
extern "C" {
::vtkAlgorithmOutput *cxxbridge1$192$vtk_algorithm_output_new() noexcept {
  ::vtkAlgorithmOutput *(*vtk_algorithm_output_new$)() = ::vtk_algorithm_output_new;
  return vtk_algorithm_output_new$();
}

void cxxbridge1$192$vtk_algorithm_output_delete(::vtkAlgorithmOutput &algorithm_output) noexcept {
...
void cxxbridge1$192$vtk_algorithm_output_set_index(::vtkAlgorithmOutput &algorithm_output, ::std::int64_t index) noexcept {
...
::std::int64_t cxxbridge1$192$vtk_algorithm_output_get_index(::vtkAlgorithmOutput const &algorithm_output) noexcept {
...
void cxxbridge1$192$vtk_algorithm_output_get_producer(::vtkAlgorithmOutput const &algorithm_output, ::vtkAlgorithm const **return$) noexcept {
...
void cxxbridge1$192$vtk_algorithm_output_set_producer(::vtkAlgorithmOutput &algorithm_output, ::vtkAlgorithm const &producer) noexcept {
