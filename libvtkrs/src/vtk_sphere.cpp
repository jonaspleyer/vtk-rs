...
vtkSphere* sphere_new() { return vtkSphere::New(); }

void sphere_delete(vtkSphere& sphere) { sphere.Delete(); }

void sphere_delete_pin(vtkSphere& sphere) { sphere.Delete(); }
...
void sphere_set_radius(vtkSphere& sphere, double radius) { sphere.SetRadius(radius); }
