...
extern "C" void sphere_source_set_phi_resolution(void *sphere_source_ptr, double resolution);
extern "C" void sphere_source_set_theta_resolution(void *sphere_source_ptr, double resolution);
